...
|---|---|---|
| 예술의전당 콘서트홀 (2,505석) | 층별 총계, 합창석 274 | 줄 수·줄별 분포, 등급 |
...
무대 뒤 P구역은 "1층 P구역 뒤편에 파이프오르간이 설치"라는 공식 안내를 근거로 삼았고,
L/R 은 이름을 그대로 읽었다. 반면 롯데 A~E 가 앞뒤로 놓인 건지 세종처럼 좌우로 놓인
건지는 확인할 자료가 없어 앞뒤로 봤다 — 근거 없는 쪽이라 yml 주석에 그렇게 적어뒀다.
