...
/**
 * 사용자에게 보여줄 알림 한 건. 종류는 {@link NotificationType} 세 가지 — 찜한 공연 회차
 * 오픈, 확정 예매 임박(D-1), 관람평 요청.
 *
 ...
 * "이미 보냈음"으로 해석한다(WishlistService 가 중복 찜을 다루는 방식과 같다).
 *
 * <p>그 결과 <b>한 공연당 한 사람에게 한 종류는 한 번만</b> 간다. SCHEDULE_OPENED 는 8월
 * 회차가 다 지난 뒤 9월 회차가 열려도 다시 알리지 않는다 — 재알림의 가치보다 매일 같은
...
public class Notification {
     ...
     * 형태가 안 바뀌는 몇 안 되는 조사라 안전하다. 나머지 둘은 일부러 조사로 시작하지 않는다.
     ...
     * 고정 명사 뒤로 옮겨, 공연명이 무엇으로 끝나든 문장이 안 깨지게 했다.
     */
